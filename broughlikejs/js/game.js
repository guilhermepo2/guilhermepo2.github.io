...
function showTitle() {
    ...
    drawText("COOL", 40, true, canvas.height / 2 - 110, "white");
...
function initSounds() {
    sounds = {
        hit1 : new Audio('assets/hit1.wav'),
        hit2 : new Audio('assets/hit2.wav'),
        treasure : new Audio('assets/treasure.wav'),
        newLevel : new Audio('assets/newLevel.wav'),
        spell : new Audio('assets/spell.wav'),
